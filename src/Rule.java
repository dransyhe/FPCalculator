...
public class Rule {
    ...
    // initialise a Rule from leftside and rightside
    public Rule(String leftSide, String[] rightSide){
        this.leftSide = leftSide;
        this.rightSide = rightSide;
    }

    // initialise a Rule from Rule
    ...
    public boolean equals(Object obj){
        ...
        if (!Arrays.deepEquals(this.rightSide, other.rightSide)) return false;
        return true;
    }
    ...
    public String toString(){
        String str = leftSide + "->";
        for (int i = 0; i < rightSide.length; i++) str += rightSide[i] + " ";
        return str;
    }
}
